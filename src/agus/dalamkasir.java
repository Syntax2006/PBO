 ...
 * @author PC
 */
public class dalamkasir extends javax.swing.JFrame {

    /**
     * Creates new form dalamkasir
     */
    public dalamkasir() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dalamkasir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new dalamkasir().setVisible(true);
            }
        });
    }
